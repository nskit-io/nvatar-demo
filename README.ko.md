...
대부분의 AI 챗봇은 상태 없는 텍스트 생성기입니다. NVatar는 **3D 룸에 사는 AI 친구** — 대화를 기억하고, 시간이 지나면서 성격이 발전하고, 8차원 감정을 추적하며, 복제된 사람 목소리로 32개 이상의 언어를 말합니다.
...
- **스폰서** — [GitHub Sponsors](https://github.com/sponsors/nskit-io) (준비 중)
